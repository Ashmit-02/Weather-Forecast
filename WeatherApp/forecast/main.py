...
def weather_view(request):
    if request.method == 'POST':
        ...
        if 'error' in current_weather:
            error_message = f"Could not retrieve weather data for {city}. Please check the city name and try again."
            return render(request, "weather.html", {'error': error_message})


        csv_path =os.path.join('C:\\Users\\LENOVO\\PycharmProjects\\WeatherPredictionApp\\weather.csv')
